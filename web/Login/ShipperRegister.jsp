...
<body>
    ...
    <%request.setAttribute("action", "/SWP391/ConfirmShipEmail");%>
    <%request.setAttribute("backTo", "/SWP391/Login/Login.jsp");%>
    <%request.setAttribute("content", new String[]{"LogElements/Username.jsp","LogElements/DoublePassword.jsp","LogElements/Email.jsp","LogElements/VehicleID.jsp","LogElements/Phone.jsp"});%>
