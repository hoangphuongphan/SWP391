        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item col-2">
                    <a class="nav-link active" aria-current="page" href="/SWP391/ShowShipperHome">Home</a>
                </li>
                <li class="nav-item col-2">
                    <a class="nav-link" href="/SWP391/Shipper/Wallet.jsp">Wallet</a>
                </li>
                <li class="nav-item col-2">
                    <a class="nav-link" href="/SWP391/Shipper/Profile.jsp">Profile</a>
                </li>
                <li class="nav-item col-2">
